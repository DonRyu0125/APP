...
const NOIMMAGE_PATH                    = "/mylang/assets/img/image-placeholder.png";
...
**
 *****/
var setupBrowseField = function(caller, field_type) {
  // RL-2021028
  var view_class = '';
  ...
  switch (field_type) {
    case 'people':
      ...
      if ( $(caller).hasClass('no_view_link') == false ) {  // RL-2021-05-31
    ...
    case 'event':
      ...
      break;
    case 'acc':
      if ( !readonly_field ) {  // kn 2021-01-28 taken from changes to M3Dev rl-2020-09-29
    ...
    case 'file_upload':
      if ( !readonly_field ) {  // rl-2020-09-29
        browse_chrome.append($('<li><a class="load" title="Attach File"><i class="fa fa-paperclip fa-lg"></i></a></li>'));
      }  // rl-2020-09-29
      if ( $(caller).hasClass('no_view_link') == false ) {  // RL-2021-05-31
      ...
      break;
    case 'image_upload':
      browse_chrome.append($('<li><a class="load" title="Attach Image"><i class="fa fa-file-image-o fa-lg"></i></a></li>'));
      if ( $(caller).hasClass('no_view_link') == false ) {  // RL-2021-05-31
    ...
    case 'video_upload':
      if ( !readonly_field ) {  // rl-2020-09-29
        browse_chrome.append($('<li><a class="load" title="Attach Video"><i class="fa fa-file-video-o fa-lg"></i></a></li>'));
      }  // rl-2020-09-29
      if ( $(caller).hasClass('no_view_link') == false ) {  // RL-2021-05-31
    ...
    case 'audio_upload':
      if ( !readonly_field ) {  // rl-2020-09-29
        browse_chrome.append($('<li><a class="load" title="Attach Audio"><i class="fa fa-file-audio-o fa-lg"></i></a></li>'));
      }  // rl-2020-09-29
      if ( $(caller).hasClass('no_view_link') == false ) {  // RL-2021-05-31
    ...
    case 'text_upload':
      if ( !readonly_field ) {  // rl-2020-09-29
        browse_chrome.append($('<li><a class="load" title="Attach Document"><i class="fa fa-file-text-o fa-lg"></i></a></li>'));
      }  // rl-2020-09-29
      if ( $(caller).hasClass('no_view_link') == false ) {  // RL-2021-05-31
    ...
    case 'medium':
      ...
      break;
    case 'client':
      if ( !readonly_field ) {  // RL-2021-03-28
    ...
    case 'lib':
      ...
      break;
    case 'm3':
      if ( !readonly_field ) {  // RL-2021-05-31
      ...
      break;
    case 'forbiddenword':
      if ( !readonly_field ) {  // kn-2021-08-06
    ...
    case 'recseries': // rl-2021-09-07
      ...
      if ( $(caller).hasClass('no_view_link') == false ) {
    ...
    case 'ministry':
      ...
      break;
    case 'collectioncode':
      if ( !readonly_field ) {  // kn-2021-11-27
...
var setupGroupList = function(caller) {
  ...
  if ( numocc == 0 ) {
    ...
    occurrences_html.append('<tr><td colspan="' + th_tags.length + '" data-empty="Y">No occurrence</td></tr>');
  }
  else {
    ...
    if ( typeof marc_subfield != 'undefined' ) {
      if ( typeof marc_subfield[id] != 'undefined' ) {
        ...
        if ( $(subfld_popup).length > 0 ) {
          ...
          var subfield_select = $("[name='subfield-list']"); <!-- RL-20220107 -->
