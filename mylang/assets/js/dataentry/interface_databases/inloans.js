function InloansInterface(record, params) {
  ...
  this.handleNomenclature = function(calling_field) {
    $.colorbox({
      href: app_interface.interface_params.base_url + '/M2A_NOMENCLATURE?DIRECTSEARCH',
      iframe: true,
      width: '900px',
      height: '600px',
      onCleanup: function() {
      ...
      onClosed: function() {
        app_interface.populateField('REG_CATEGORY', 1, null, false); // RL2021-05-31
        app_interface.populateField('R_CLASSIFICATION', 1, null, false); // RL2021-05-31
        app_interface.populateField('REG_SUB_CLASSIFY', 1, null, false); // RL2021-05-31
        app_interface.populateField('REG_PRIMARY', 1, null, false); // RL2021-05-31
        app_interface.populateField('REG_SECONDARY', 1, null, false); // RL2021-05-31
        app_interface.populateField('REG_TERTIARY', 1, null, false); // RL2021-05-31
        delete $tmp_data;
      }
    });
  };
