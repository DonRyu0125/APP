...
const AOOPAC_SCRIPT_PATH = 'https://m2auat.minisisinc.com/scripts/mwimain.dll';
        ...
        if (field_handle.length > 0) {
            ...
            if (form_action === undefined || form_action == null || form.length <= 0) {
                ...
                if (web_enquiry) {
                    ...
                    url = AOOPAC_SCRIPT_PATH + '?CHANGESINGLERECORD&APPLICATION=ENQUIRIES_VIEW&LANGUAGE=$lang&DATABASE=ENQUIRIES_VIEW&de_form=%5bAO_ASSETS%5dhtml/editEnquiry.html&rid=edit-inquiry&EXP=ENQ_ID~20' + enquiry_id;
