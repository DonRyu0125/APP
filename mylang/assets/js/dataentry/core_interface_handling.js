...
const SITE_ROOT_PATH          = "https://m2auat.minisisinc.com/mylang";
const SITE_MEDIA_FOLDER       = "media";
const MEDIA_VD_NAME           = '[MEDIA]';
const DEFAULT_MEDIA_PATH      = "C:\\M2A\\IMAGES\\";
const DEFAULT_MEDIA_WEB_PATH  = "/mylang/" + SITE_MEDIA_FOLDER + "/";
const UPLOAD_HTML_FILE        = "[cams_app]\\mylang\\upload.html";
const IMAGE_GROUP             = 'a_im_ref_grp';
const NOIMAGE_WWW_PATH        = '/mylang/assets/img/image-placeholder.png';
...
function ApplicationInterface(record, params) {
  ...
  params = (typeof params !== 'undefined') ? params : {
    ...
    'base_url': SITE_ROOT_PATH + '/scripts/mwimain.dll/144',
    ...
    // RL-2020-11-10 RL-2021-01-08
    'tdr_map':
    //kn - 2021-08-13 line 133 to 166
    {
  ...
  this.contextMenu = function (calling_field, mouse_position) {
    ...
    var nomenu = $(calling_field).parent().data('NOMENU');
    if ( typeof nomenu == 'undefined' || nomenu != 'Y' ) {
  ...
  this.getValidatedTable = function (calling_field) {
    ...
    if ( class_name != 'load' ) {
      ...
      $added_record = false;
      $selected_field_value = {};  // RL-20220922
        ...
        onClosed: function () {
          ...
          if ( formdata != 'Y' ) {  // RL-20220420
            if (typeof parent_group !== 'undefined') {
              ...
              app_interface.populateField(calling_element_id, 1, null, false); // RL-2021-05-31
              ...
              for ( var i = 0 ; i < map.length ; i++ ) {
                ...
                if ( calling_element_id != tmp_val ) {
                  app_interface.populateField(tmp_val, 1, null, false);  // RL-20211025
                }
              }
            }
          }
          ...
          delete $selected_field_value; // RL-20220922
    ...
    $(calling_field).colorbox({
      ...
      onClosed: function () {
        if (typeof tmp_val !== 'undefined') {
          ...
          console.log("Error: Value wasn't set");
        }
      }
    });
  };
 ...
 this.uploadFile = function (calling_field) {
    ...
    // RL-2020-09-29
    url = params.sessid + "?get&file=" + UPLOAD_HTML_FILE + "&parm1=" + accession_number + "&parm2=" + params.image_virtual_directory;
    // RL-2021-05-31
    var dialog_width = window.innerWidth - 8; // leave spaces in left and right margin
    var dialog_height = window.innerHeight - 13;  // leave spaces in top and bottom margin
  ...
  this.editRecord = function (calling_field) {
    ...
    if ( okay ) {
      ...
      var url = params.sessid + '?CHANGESINGLERECORD&NEW=Y&DISCONNECT=Y' +
       ...
       '&RETURN_URL=' + params.sessid + '%3fget%26file=[CAMS_APP]/mylang/assets%5chtml%5ctemplate%5cclose_form.html';
