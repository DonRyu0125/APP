...
const minisis_online_default_icon =  ["/mylang/icons/minisis_default_database_00_01.png", // Database (Archive, Museum, Library)
                                      ...
                                      "/mylang/icons/minisis_default_sub_collection_02.png", // Sousfonds, sub-collections
                                      ...
                                      "/mylang/icons/minisis_default_component_09.png"]; // Component
...
function TreeControl ( parm_file, location_id ) {
  ...
  this.promptImportFile = function (obj) {
    ...
    if ( runImportBtn == null ) {
      ...
      if ( import_colorbox ) {
        // setup colorbox
        var url = getHomeSessId() + "?get&file=[CAMS_APP]/mylang/select_import_file.html";
