...
<body class="file_upload">
	...
	?>
		...
		<form method="post" enctype="multipart/form-data">
			...
			<input type="file" onchange="displayImg(this);" name="file" id="file">
			<br>
			<br>
			<img id="img-selected" src="/m2aonline/assets/img/image-placeholder.png" alt="Selected File" />
			<br>
		...
		<script>
			...
			var file = '<?php echo $new_filename.'.
			'.$ext; ?>';
			parent.$tmp = file;
