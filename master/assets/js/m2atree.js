...
const ford_test_icon = [ "/144/icons/minisis_default_database_00_01.png", // Database Lvl 0
                         "/144/icons/ford_placeholder_accession_01.png",  // Accession Lvl 1
                         "/144/icons/ford_placeholder_box_02.png",        // Box Lvl 2
                         "/144/icons/ford_placeholder_folder_03.png",     // Folder Lvl 3
                         "/144/icons/ford_placeholder_item_04.png"        // Item Lvl 4
                    ];
const minisis_online_default_icon =  ["/144/icons/minisis_default_database_00_01.png", // Database (Archive, Museum, Library)

                                      "/144/icons/minisis_default_collection_01.png", // Fonds, Collections
                                      "/144/icons/minisis_default_sub_collection_02.png", // Sousfonds, sub-collections

                                      "/144/icons/minisis_default_series_03.png", // Series
                                      "/144/icons/minisis_default_sub-series_04.png", // Sub-series
                                      "/144/icons/minisis_default_sub-sub-series_05.png", // Sub-sub-series

                                      "/144/icons/minisis_default_file_06.png", // File
                                      "/144/icons/minisis_default_file_part_07.png", // File part
                                      "/144/icons/minisis_default_item_08.png", // Item
                                      "/144/icons/minisis_default_component_09.png"]; // Component

const lma_desc_icon = ["/144/icons/0-foldericon.png",
                       "/144/icons/1-fondsfoldericon.png",
                       "/144/icons/2-sousfondsfoldericon.png",
                       "/144/icons/3-seriesfoldericon.png",
                       "/144/icons/4-series2foldericon.png",
                       "/144/icons/5-series3foldericon.png",
                       "/144/icons/6-filefoldericon.png",
                       "/144/icons/7-filepartfoldericon.png",
                       "/144/icons/8-item_fol.png",
                       "/144/icons/9-tree_r.png"];

const default_desc_icon = ["/144/icons/0-foldericon.png",
                           "/144/icons/1-fondsfoldericon.png",
                           "/144/icons/2-sousfondsfoldericon.png",
                           "/144/icons/3-seriesfoldericon.png",
                           "/144/icons/4-series2foldericon.png",
...
function treeAjaxPostCall ( request_url, form_data ) {
  var result_data = null;
  var result_code = 0;
  var result_value = null;
...
function TreeControl ( parm_file, location_id ) {
  ...
  this.promptImportFile = function (obj) {
    ...
    if ( runImportBtn == null ) {
      m2a_tree.importRecord ( obj.id, false );
    }
    else {
      var  import_colorbox = ture;

      if ( import_colorbox ) {
        // setup colorbox
        var url = getHomeSessId() + "?get&file=[CAMS_APP]/144/select_import_file.html";

        delete $import_formdata;
        $import_formdata = null;
        ...
        $.colorbox({
          ...
          onClosed: function () {
            ...
            if ( realFileBtn != null ) {
              ...
              parent.$import_formdata = new FormData();
              parent.$import_formdata.append ( realFileBtn, file );

              // show progress icon
              var import_icon = document.getElementById( 'upload-waiting' );
              if ( import_icon != null ) {
                $(import_icon).css('display', 'block' );
              }

              parent.m2a_tree.importRecord ( parent.m2a_tree.m_select_node_id, true );
              parent.m2a_tree.m_select_node_id = "";
            }
          }
        });
      }
        ...
        if ( realFileBtn != null ) {
          ...
          if ( tree_node != null ) {
            ...
            $(runImportBtn).on("click", function (e) {
              ...
              if ( v != "" ) {
                m2a_tree.importRecord ( m2a_tree.m_select_node_id, false );
              }
  ...
  this.importRecord = function (node_id, colorbox_dialog ) {
    var tree_node = null;
    ...
    if ( tree_node != null ) {
      ...
      var file_field_id = "";
      var form_data = null;
      var proceed_import = false;

      if ( colorbox_dialog ) {
        form_data = $import_formdata;
        proceed_import = true;
      }
      else {
        if ( runImportBtn == null ) {
      ...
      if ( proceed_import ) {
        ...
        var import_icon = document.getElementById( 'importing' );
        if ( !colorbox_dialog && import_icon != null ) {
          $(import_icon).css('display', 'block' );
        }

          // submit IMPORTTREE command
          var ajax_result = treeAjaxPostCall ( url, form_data );

          if ( !colorbox_dialog && import_icon != null ) {
            $(import_icon).css('display', 'none' );
          }

          if ( !colorbox_dialog && runImportBtn != null ) {
            // close modal dialog
          ...
          if ( ajax_result.m_result_code != 0 ) {
            ...
            if ( jstree_node ) {
              ...
              if ( v != null && v != "" ) {
                ...
                if ( confirm_view ) {
                  url = this.m_home_sessid + "?VIEWTEXTFILE" + "&file=" + v;
