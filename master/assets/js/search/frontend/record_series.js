// RL-2021-06-21
// record series search expression
var search_title = '';
...
$('#TODO_LIST').change(function(e) {
  $('#NEGOTIATED_SERIES').attr('checked', false);
...
$('#NEGOTIATED_SERIES').change(function(e) {
...
function buildExpression(show_all)
{
  ...
  if ($('#TODO_LIST').is(":checked")) {
    ...
    search_exp = "RS_REQ_APPROVE REQUESTED * RS_STATUS <> ACTIVE";
  }
  else if ($('#NEGOTIATED_SERIES').is(":checked")) {
    search_title = 'Negotiated Record Series';
    search_exp = "RS_STATUS NEGOTIATE";
  }
