function CollectionsInterface(record, params) {
  ...
  var component_params = {
    ...
    'new_component_url' : function(sisn) {
      return app_interface.interface_params.sessid + '/?CHANGESINGLERECORD&DATABASE=COLLECTION_COMPONENT&EXP=SISN+' + replaceAll(sisn, ' ', '%20') + '&COPYRECORD=Y&NEW=Y&EXCLUDE=LAST_MODIFIED+CHILD_LINK&DE_FORM=[CAMS_APP]/144/dataentry%2fcomponents.html';
    },
    'component_edit_url' : function(sisn) {
      return app_interface.interface_params.sessid + '/?CHANGESINGLERECORD&DATABASE=COLLECTION_COMPONENT&EXP=SISN+' + replaceAll(sisn, ' ', '%20') + '&DE_FORM=[CAMS_APP]/144/dataentry%2fcom_edit.html';
    }
  };
