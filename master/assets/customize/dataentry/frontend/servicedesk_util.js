...
function sendReadyEmail( order_num, patronEmail, reqItemID, itemTitle, patronName )
{
  if ( patronEmail != null && patronEmail != '' ) {
    ...
    editrecord_url = editrecord_url + '?CHANGESINGLERECORD' +
      encodeURIComponent('&APPLICATION=ADD_REQ_INFO&LANGUAGE=144&rid=request-booking&EXP=REQ_ORDER_NUM+' + order_num);

    var email_body = loadEmailBody ( "[cams_app]144%5cassets%5chtml%5ctemplate%5citem_ready.html" );
