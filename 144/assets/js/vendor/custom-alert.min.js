...
function customAlert(inGlobalVar) {
    ...
    var createDom = function(type) {
        ...
        this.custParent = function(custParent, wrap) {
            wrap = (wrap) ? document.querySelector(wrap) : document;
            custParent = wrap.querySelector(custParent)
            custParent.appendChild(this.el);
            return this;
        }
    ...
    if (document.getElementById("customconfirm") == null) {
        ...
        }).custParent(".footer", "#customconfirm")

        createDom('button').attr({
            "class": "btn btn-danger button-cancel button-done",
